...
<body>
        ...
        <aside class="rdm-alert rdm-alert--error" role="alert" aria-live="assertive">
            ...
            <div class="rdm-alert--body">
                <?php if (count($errores) === 1): ?>
                    <p class="rdm-sys-typography--body-large"><?= escaparTextoRecuperacion($errores[0]) ?></p>
                <?php else: ?>
    ...
    <?php if ($mensajeRecuperacion !== null): ?>
        <aside class="rdm-alert rdm-alert--info" role="status" aria-live="polite">
            <div class="rdm-alert--icon">
                <span class="material-symbols-rounded">info</span>
            </div>
            <div class="rdm-alert--body">
                <p class="rdm-sys-typography--body-large"><?= escaparTextoRecuperacion($mensajeRecuperacion) ?></p>
            </div>
        </aside>
    <?php endif; ?>
